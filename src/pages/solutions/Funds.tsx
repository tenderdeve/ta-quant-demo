...
const features = [
  {
    ...
    description:
      "Execute complex portfolio strategies across multiple exchanges simultaneously. Manage large positions with minimal market impact using TWAP, VWAP, and smart routing.",
  },
  {
    icon: BarChart3,
    title: "Risk Management",
    description:
      "Real-time risk monitoring with VaR calculations, portfolio Greeks, correlation analysis, and scenario testing. Protect your fund's capital with institutional-grade risk controls.",
  },
  {
    icon: TrendingUp,
    title: "Performance Analytics",
    description:
      "Comprehensive performance attribution, P&L analysis, and trade reporting. Understand what's driving returns and optimize your strategies accordingly.",
  },
  {
    icon: Zap,
    title: "Low-Latency Execution",
    description:
      "Sub-100ms data latency and sub-500ms order execution ensure you capture opportunities before they disappear. Execute at institutional speeds.",
  },
  {
    icon: Shield,
    title: "Enterprise Security",
    description:
      "SOC 2 compliant infrastructure with bank-grade security. Multi-factor authentication, IP whitelisting, and comprehensive audit trails for compliance.",
  },
  {
    icon: PieChart,
    title: "Multi-Exchange Access",
    description:
      "Trade across 50+ exchanges from a single interface. Access global liquidity, reduce slippage, and optimize execution costs across venues.",
  },
];
          ...
          >
            <AnimatedText delay={0.2}>
              <div className="inline-flex items-center gap-3 mb-8">
                <motion.div
                  className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center"
            ...
            <h1 className="font-display font-bold text-4xl md:text-6xl mb-8 leading-tight">
              <StaggerText text="Institutional execution" className="block mb-2" delay={0.4} />
              <StaggerText text="for crypto funds" className="block gradient-text" delay={0.7} />
            </h1>
            <AnimatedText delay={1.0} variant="slide">
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Execute large positions across multiple exchanges with minimal market impact. 
                Manage risk, analyze performance, and scale your fund with confidence.
              </p>
            </AnimatedText>
          ...
          <AnimatedText delay={0.2}>
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto leading-relaxed">
                Everything you need to execute strategies, manage risk, and scale your fund 
      ...
      <section ref={benefitsRef} className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <AnimatedText delay={0.2}>
            <div className="text-center mb-16">
              <h2 className="font-display font-bold text-3xl md:text-4xl mb-4 leading-tight">
                Why funds trust TA Quant
              </h2>
              <p className="text-muted-foreground max-w-xl mx-auto leading-relaxed">
                Proven infrastructure trusted by crypto funds managing billions in assets.
              </p>
            </div>
          </AnimatedText>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground mb-10 leading-relaxed text-lg">
                  Join leading crypto funds using TA Quant for execution and risk management. 
